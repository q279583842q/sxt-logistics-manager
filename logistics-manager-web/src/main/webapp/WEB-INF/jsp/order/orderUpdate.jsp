			...
			<form action="/order/save" method="post" id="myform">
				...
				<table class="tablelist1" id="orderDetailID">
					<tr>
						...
						<td class="td2">备注</td>
						<td align="center">
							<img  src="/images/t01.png" id="mytab1" 
							style="width: 20xpx;height: 20px;">
						</td>
					</tr>
					<tr class="mytr" >
						<td align="center"><input type="text" name="orderDetails[][goodsName]"></td>
						<td align="center"><input type="text" class="goodsNumber" style="width: 50px;" 
						name="orderDetails[][goodsNumber]" onblur="calculateTotalNumber(this)"></td>
						<td align="center"> 
						...
						style="width: 50px;" name="orderDetails[][goodsUnitPrice]" 
